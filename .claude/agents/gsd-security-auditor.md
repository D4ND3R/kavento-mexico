...
**Verification depth scales with `asvs_level`** (see @C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
