...
Read and follow `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
