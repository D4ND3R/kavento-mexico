...
- **Global scope**: `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/notes/`)
...
2. Glob `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/notes/` — works in any directory
