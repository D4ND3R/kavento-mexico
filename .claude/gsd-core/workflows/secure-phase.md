...
```
Agent(
  prompt="Read C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/d4nd3r/Desktop/Kavento_Mexico/.claude/gsd-core/templates/SECURITY.md`
